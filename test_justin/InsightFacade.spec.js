...
describe("InsightFacade Add/Remove/List Dataset", function () {
    const datasetsToLoad = {
        courses: "./test_justin/data/courses.zip",
        underscore_courses: "./test_justin/data/courses_underscore.zip",
        invalidZip: "./test_justin/data/invalid_zip.zip",
        invalidJson: "./test_justin/data/invalid_json.zip",
        noSectionCourses: "./test_justin/data/noSectionCourses.zip"
    };
    let datasets = {};
    let insightFacade;
...
describe("InsightFacade PerformQuery", () => {
    const datasetsToQuery = {
        courses: {
            path: "./test_justin/data/courses.zip",
            kind: IInsightFacade_1.InsightDatasetKind.Courses,
        },
        coursesSmall: {
            path: "./test_justin/data/coursesSmall.zip",
            kind: IInsightFacade_1.InsightDatasetKind.Courses,
        },
    };
    let insightFacade;
